...
- [ ] **Task 2.1:** Install markdown-it and plugins
...
- [ ] **Task 2.2:** Install Shiki for server-side syntax highlighting
  - Run: `npm install shiki`

- [ ] **Task 2.3:** Install DOMPurify and jsdom for HTML sanitization
  - Run: `npm install dompurify jsdom`
  - Run: `npm install -D @types/dompurify @types/jsdom`

### Shared Markdown Configuration

- [ ] **Task 2.4:** Create shared markdown-it configuration
...
- [ ] **Task 2.5:** Create server markdown service
...
- [ ] **Task 2.6:** Implement Shiki highlighter initialization
...
- [ ] **Task 2.7:** Configure markdown-it with Shiki highlighting
  - In `src/server/services/markdown.ts`
...
- [ ] **Task 2.8:** Implement `render()` method
  - In `src/server/services/markdown.ts`
...
- [ ] **Task 2.9:** Implement `renderSanitized()` method
  - In `src/server/services/markdown.ts`
...
- [ ] **Task 2.10:** Export singleton instance
  - In `src/server/services/markdown.ts`
...
- [ ] **Task 2.13:** Configure highlight.js integration
...
- [ ] **Task 2.14:** Implement client `render()` function
  - In `src/client/services/markdown.ts`
  - Export function: `render(markdown: string): string`
  - Synchronous (no async needed for client)
  - Return rendered HTML

- [ ] **Task 2.15:** Implement client `renderSanitized()` function
  - In `src/client/services/markdown.ts`
...
- [ ] **Task 2.16:** Create shared sanitization config
...
- [ ] **Task 2.17:** Add markdown types to shared types
...
- [ ] **Task 2.18:** Verify markdown rendering
...
- [ ] Server markdown service renders GFM markdown to HTML
- [ ] Client markdown service renders GFM markdown to HTML
- [ ] Code blocks have syntax highlighting applied
- [ ] Task lists render as interactive checkboxes
- [ ] Footnotes render correctly with back-references
- [ ] Anchor IDs are added to headings
- [ ] XSS payloads are stripped from output
- [ ] `<script>`, `<iframe>`, and other dangerous tags are removed
- [ ] Links work correctly, external links have `rel="noopener noreferrer"`
