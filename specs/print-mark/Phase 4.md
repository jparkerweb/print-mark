...
- [ ] Phase 2 must be complete (markdown rendering)
...
- [ ] **Task 4.1:** Install CodeMirror 6 packages
...
- [ ] **Task 4.2:** Update HTML entry point
...
- [ ] **Task 4.3:** Create application layout styles
...
- [ ] **Task 4.4:** Create main application entry point
...
- [ ] **Task 4.5:** Create simple state management
...
- [ ] **Task 4.6:** Create toolbar styles
...
- [ ] **Task 4.7:** Create toolbar component
...
- [ ] **Task 4.8:** Implement file upload handler
...
- [ ] **Task 4.9:** Implement drag-and-drop file upload
...
- [ ] **Task 4.12:** Create editor styles
...
- [ ] **Task 4.13:** Create CodeMirror editor component
...
- [ ] **Task 4.14:** Implement editor content sync
...
- [ ] **Task 4.15:** Add editor placeholder content
  - In `src/client/components/editor.ts`
...
- [ ] **Task 4.16:** Create preview styles
...
- [ ] **Task 4.17:** Create preview component
...
- [ ] **Task 4.18:** Implement theme application in preview
...
- [ ] **Task 4.19:** Implement scroll sync (optional enhancement)
  - In `src/client/components/preview.ts`
...
- [ ] **Task 4.22:** Create "Export PDF" button (UI only)
  - In `src/client/components/toolbar.ts`
...
- [ ] **Task 4.23:** Create toast notification system
...
- [ ] **Task 4.25:** Add responsive styles
...
- [ ] **Task 4.26:** Add split-pane resizing (optional)
...
- [ ] **Task 4.27:** Implement error boundary
...
- [ ] **Task 4.28:** Verify frontend functionality
...
- [ ] Editor accepts markdown input with syntax highlighting
- [ ] Preview updates in real-time as user types (debounced)
- [ ] File upload works via button click and drag-drop
- [ ] Theme picker shows all 4 themes
- [ ] Theme changes are reflected immediately in preview
- [ ] "Copy HTML" copies sanitized HTML to clipboard
- [ ] "Print" opens browser print dialog with correct styling
